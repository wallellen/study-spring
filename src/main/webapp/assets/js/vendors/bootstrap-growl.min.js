...
(function (e, t, n, r) {
    ...
    var u = function (t, n) {
        ...
        var i = {settings: n, $element: e(n.element), template: n.template};
        if (typeof n.offset == "number") {
            n.offset = {x: n.offset, y: n.offset}
        }
        $template = c(i);
        h($template, i.settings);
        p($template, i.settings);
        d($template, i.settings, r)
    }, c = function (t) {
        ...
        if (t.settings.allow_dismiss) {
            n.find('[data-growl="dismiss"]').css("display", "inline-block")
        }
        return n
    }, h = function (e, t) {
